function [Data] = readtank_sdk_new_tanks(folder_path,BlockNumber,ChannelNumber,preamp)
%
...
if strcmp(preamp,'XPZ2')
    ChannelNumber = ChannelNumber+32;
        data = TDTbin2mat(BLOCK_PATH,'TYPE',[2 3],'CHANNEL',ChannelNumber,'NODATA',1); %'eNe2 (32-128)
        data.snips.eNe1=[];
        data.Fs=data.snips.eNe2.fs;
        data.Trig=data.epocs.Trir.data/data.Fs;
         %XPZ5==>eNe1 only 64 channels
elseif strcmp(preamp,'XPZ5')
    ...
    elseif ChannelNumber > 64
        data = TDTbin2mat(BLOCK_PATH,'TYPE',[2 3],'CHANNEL',ChannelNumber-64,'NODATA',1); %eNe2
        data.snips.eNe1=[];
        data.Fs=data.snips.eNe2.fs;
        data.Trig=data.epocs.Trir.data/data.Fs;
